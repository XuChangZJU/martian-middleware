(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('normalizr'), require('martian-domain/lib/constants/errorCode'), require('sha1')) :
	typeof define === 'function' && define.amd ? define(['normalizr', 'martian-domain/lib/constants/errorCode', 'sha1'], factory) :
	(factory(global.normalizr,global.errorCode,global.sha1));
}(this, (function (normalizr,errorCode,sha1) { 'use strict';

normalizr = normalizr && normalizr.hasOwnProperty('default') ? normalizr['default'] : normalizr;
errorCode = errorCode && errorCode.hasOwnProperty('default') ? errorCode['default'] : errorCode;
...
var shim$2 = function (object) {
	return keys$2(object == null ? object : Object(object));
};

var keys = isImplemented$4()
	? Object.keys
	: shim$2;
...
var API_MW_SYMBOL = es6Symbol('Call_API');
...
var apiMiddleware_2 = apiMiddleware_1.API_MW_SYMBOL;
var apiMiddleware_3 = apiMiddleware_1.apiMiddleware;
var apiMiddleware_4 = apiMiddleware_1.setNetAvailable;
var apiMiddleware_5 = apiMiddleware_1.addEvent;
var apiMiddleware_6 = apiMiddleware_1.removeEvent;
...
var errorMiddleware_1 = {
    errorMiddleware: errorMiddleware,
    registerErrorHandler: registerErrorHandler
};

var errorMiddleware_2 = errorMiddleware_1.errorMiddleware;
var errorMiddleware_3 = errorMiddleware_1.registerErrorHandler;

//import merge from 'lodash/merge';


var POPULATE_HTTP_HEADER_MW_SYMBOL = es6Symbol('PREQUEST_MIDDLEWARE');
// import {API_MW_SYMBOL} from 'api-middleware';
var API_MW_SYMBOL$1 = apiMiddleware_1.API_MW_SYMBOL;
    ...
    return function (_ref) {
        ...
        return function (next) {
            return function (action) {
                ...
                var request = prequest[API_MW_SYMBOL$1];
                ...
                prequest[API_MW_SYMBOL$1].init = merge_1({}, request.init, {
...
var populateHttpHeaderMiddleware = {
...
var populateHttpHeaderMiddleware_1 = populateHttpHeaderMiddleware.genPopulateHttpHeaderMiddleware;
var populateHttpHeaderMiddleware_2 = populateHttpHeaderMiddleware.POPULATE_HTTP_HEADER_MW_SYMBOL;
...
module.exports = {
    apiMiddleware: apiMiddleware_3,
    errorMiddleware: errorMiddleware_2,
    genPopulateHttpHeaderMiddleware: populateHttpHeaderMiddleware_1,
    //
    setNetAvailable: apiMiddleware_4,
    addEvent: apiMiddleware_5,
    removeEvent: apiMiddleware_6,
    API_MW_SYMBOL: apiMiddleware_2,
    //
    POPULATE_HTTP_HEADER_MW_SYMBOL: populateHttpHeaderMiddleware_2,
    //
    registerErrorHandler: errorMiddleware_3
};
